...
-- DropForeignKey
ALTER TABLE "public"."participants" DROP CONSTRAINT "participants_program_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."participants" DROP CONSTRAINT "participants_registration_id_fkey";
...
-- DropForeignKey
ALTER TABLE "public"."programs" DROP CONSTRAINT "programs_event_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."registrations" DROP CONSTRAINT "registrations_event_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."registrations" DROP CONSTRAINT "registrations_org_id_fkey";
